      ...
      <div style={styles.container}>
        ...
        <div style={styles.filterRow}>
          ...
          {categories.map((cat) => (
            <button
              key={cat.id}
              style={selectedCategory === String(cat.id) ? styles.filterBtnActive : styles.filterBtn}
...
const styles = {
  ...
  searchInput: {
    ...
    fontSize: "13px", fontFamily: "'Poppins', sans-serif", width: "150px", color: "#444",
  },
  logoutBtn: {
  ...
  filterRow: { display: "flex", gap: "10px", flexWrap: "wrap", marginBottom: "32px" },
  filterBtn: {
